 ...
 */
        ...
        $assign_to_config['template_group'] = 'blackboard';
//        $assign_to_config['template'] = 'index';
//	$assign_to_config['site_index'] = '';
//	$assign_to_config['site_404'] = '';
	$assign_to_config['global_vars'] = array(); // This array must be associative
        $assign_to_config['global_vars']['site_version'] = 'bb';
        $assign_to_config['global_vars']['images_folder'] = '/homepages/2/d108111940/htdocs/ee2/images/'; 
 ...
 */
	$assign_to_config['site_name'] = 'Blackboard at London Met';
	//$assign_to_config['cp_url'] = '';
        $assign_to_config['site_url'] = 'http://blackboard.studymet.co.uk/';
