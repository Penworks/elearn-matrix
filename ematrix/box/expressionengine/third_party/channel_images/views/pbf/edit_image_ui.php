<div class="ci_eiw">
    ...
    <div class="eiw_left">
        ...
        <div class="ci_eiw_bottombar bottombar">
            <span class="crop_holder" style="display:none">
                ...
                <a class="submit cancel_crop" style="float:right;margin-right:10px;"><?=lang('ci:cancel_crop')?></a>
                <br clear="all"><br>
            ...
            <span class="save_image_holder">
                ...
                <a class="submit cancel_image" style="float:right;margin-right:10px;"><?=lang('ci:cancel')?></a>
            </span>
    ...
    <div class="imgholder" style="text-align:center;">
        <img src="<?=$img_url?>" data-alturl="<?=$img_url_alt?>" id="jcrop_target" data-realwidth="<?=$img_info[0]?>" data-realheight="<?=$img_info[1]?>">
