...
class Channel_images_ft extends EE_Fieldtype
{
	...
	function display_field($data)
	{
		...
		if (REQ == 'PAGE')
		{
			// UTF Characters gets stripped somehow
			$vData['field_json'] = str_replace('\\u', '\\\u', $vData['field_json']);

			// And unescaping quotes.. wtf!
			$vData['field_json'] = str_replace('\\"', '\\\"', $vData['field_json']);
		}
